...
export declare type OAuthDeviceFlowAuthOptions =
...
export declare type FactoryInstallationOptions = StrategyOptions &
...
export declare type InstallationAccessTokenAuthentication =
...
export declare type GitHubAppUserAuthentication =
  OAuthAppAuth.GitHubAppUserAuthentication;
export declare type GitHubAppUserAuthenticationWithExpiration =
  OAuthAppAuth.GitHubAppUserAuthenticationWithExpiration;
export declare type FactoryOptions = Required<
  Omit<StrategyOptions, keyof State>
> &
  State;
...
export declare type State = Required<
  Omit<CommonStrategyOptions, "installationId">
> & {
  installationId?: number;
