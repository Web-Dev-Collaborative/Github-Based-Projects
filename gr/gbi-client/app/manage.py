...
def babel_init_lang_command(lang):
    ...
    sh(
        "pybabel init -i geobox/web/translations/messages.pot -d geobox/web/translations -l %s"
        % (lang,)
    )
...
def babel_refresh_command():
    ...
    sh(
        "pybabel extract -F babel.cfg -k lazy_gettext -k _l -o geobox/web/translations/messages.pot geobox/web geobox/model geobox/lib "
        + extensions
    )
    sh(
        "pybabel update -i geobox/web/translations/messages.pot -d geobox/web/translations"
    )
