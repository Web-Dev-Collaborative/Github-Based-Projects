...
class TrayIcon(object):
    def __init__(self, app_state, target_url="", icon_path="icon.ico"):
        ...
        self.icon = win32gui.LoadImage(
            None, icon_path, win32con.IMAGE_ICON, 0, 0, win32con.LR_LOADFROMFILE
        )
    ...
    def create_window(self, window_name="Dummy Window"):
        ...
        window_id = win32gui.CreateWindow(
            class_atom, window_name, style, 0, 0, 0, 0, 0, 0, None, None
        )
    ...
    def create_menu(self):
        ...
        win32gui.SetMenuDefaultItem(menu, EXIT_COMMAND, 0)
        item, extras = win32gui_struct.PackMENUITEMINFO(
        ...
        win32gui.TrackPopupMenu(
            menu, win32con.TPM_LEFTALIGN, x, y, 0, self.window_id, None
        )
        win32gui.PostMessage(self.window_id, win32con.WM_NULL, 0, 0)
