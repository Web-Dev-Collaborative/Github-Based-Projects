    ...
    2167: function (e, r, t) {
      ...
      var f = function (e) {
        ...
        if (e.passHref || ('a' === r.type && !('href' in r.props))) {
          var k = 'undefined' !== typeof j ? j : s && s.locale,
            I =
              s &&
              s.isLocaleDomain &&
              (0, i.getDomainLocale)(h, k, s && s.locales, s && s.domainLocales)
          _.href = I || (0, i.addBasePath)((0, i.addLocale)(h, k, s && s.defaultLocale))
        }
        return l.default.cloneElement(r, _)
      }
      r.default = f
    },
    7426: function (e, r, t) {
