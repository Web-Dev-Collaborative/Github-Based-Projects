;(function () {
  ...
  exports.ids = [888]
  exports.modules = {
    /***/ 1667: /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      'use strict'
      // ESM COMPAT FLAG
      ...
      // EXTERNAL MODULE: ./components/lib/getThemeProps.ts
      var getThemeProps = __webpack_require__(2130)
      // EXTERNAL MODULE: ./components/lib/events.ts + 1 modules
      var events = __webpack_require__(7875) // CONCATENATED MODULE: external "imurmurhash"
      var external_imurmurhash_namespaceObject = require('imurmurhash') // CONCATENATED MODULE: ./components/lib/experiment.ts
      ...
      /* harmony default export */ function experiment() {
        // *** Example test code ***
      ...
      var LanguagesContext = __webpack_require__(2467) // CONCATENATED MODULE: ./pages/_app.tsx
      ...
      const MyApp = ({ Component, pageProps, csrfToken, themeProps, languagesContext }) => {
        ...
        return /*#__PURE__*/ (0, jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
          children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(components_.ThemeProvider, {
              children: /*#__PURE__*/ (0, jsx_runtime_.jsxs)(
                LanguagesContext /* LanguagesContext.Provider */.m.Provider,
                {
                  value: languagesContext,
                  children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(SetTheme, {
      ...
      MyApp.getInitialProps = async (appContext) => {
        ...
        const { ctx } = appContext // calls page's `getInitialProps` and fills `appProps.pageProps`

        const appProps = await app.default.getInitialProps(appContext)
        const req = ctx.req
        return _objectSpread(
          _objectSpread({}, appProps),
          {},
          {
            ...
            csrfToken:
              (req === null || req === void 0
                ? void 0
                : (_req$csrfToken = req.csrfToken) === null || _req$csrfToken === void 0
                ? void 0
                : _req$csrfToken.call(req)) || '',
            languagesContext: {
      ...
      const SetTheme = ({ themeProps }) => {
        ...
        const { setColorMode } = (0, components_.useTheme)()
        ;(0, external_react_.useEffect)(() => {
          setTimeout(() => {
  ...
  var __webpack_exports__ = __webpack_require__.X(0, [544, 317, 130], function () {
    return __webpack_exec__(1667)
  })
