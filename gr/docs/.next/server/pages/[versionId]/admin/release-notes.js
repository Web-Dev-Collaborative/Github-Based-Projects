;(function () {
  ...
  exports.modules = {
    ...
    /***/ 2897: /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      'use strict'
      // ESM COMPAT FLAG
      ...
      var jsx_runtime_ = __webpack_require__(5282) // CONCATENATED MODULE: external "liquidjs"
      ...
      var useTranslation = __webpack_require__(8558) // CONCATENATED MODULE: ./components/hooks/useOnScreen.ts
      function useOnScreen(ref, rootMargin = '0px') {
        const { 0: isIntersecting, 1: setIntersecting } = (0, external_react_.useState)(false)
      ...
      var external_github_slugger_default = /*#__PURE__*/ __webpack_require__.n(
        external_github_slugger_namespaceObject
      )
      // EXTERNAL MODULE: ./components/Link.tsx
      var Link = __webpack_require__(6359) // CONCATENATED MODULE: ./components/release-notes/PatchNotes.tsx
      ...
      function PatchNotes({ patch, withReleaseNoteLabel }) {
              ...
              'div',
              {
                ...
                children: [
                  ...
                  /*#__PURE__*/ jsx_runtime_.jsx('ul', {
                    className: external_classnames_default()(
                      withReleaseNoteLabel && 'col-xl-9',
                      'col-12 release-notes-list'
                    ),
                    children: sectionItems.map((item) => {
                      ...
                      const slug = item.heading
                        ? external_github_slugger_default().slug(item.heading)
                        : ''
                      return /*#__PURE__*/ (0, jsx_runtime_.jsxs)(
                        'li',
                        {
      ...
      function GHAEReleaseNotePatch({ patch, didEnterView }) {
        const { t } = (0, useTranslation /* useTranslation */.$)('release_notes')
      ...
      function GHAEReleaseNotes({ context }) {
        const { releaseNotes, releases, currentVersion } = context
        const { 0: focusedPatch, 1: setFocusedPatch } = (0, external_react_.useState)('')
        return /*#__PURE__*/ (0, jsx_runtime_.jsxs)('div', {
          className: 'd-flex',
          children: [
                                ...
                                /*#__PURE__*/ (0, jsx_runtime_.jsxs)('div', {
                                  ...
                                  children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(
                                      octicons_react_.ChevronDownIcon,
                                      {}
                                    ),
                                  ],
                                }),
      ...
      var PrintAction = __webpack_require__(3718) // CONCATENATED MODULE: ./components/release-notes/GHESReleaseNotePatch.tsx
          ...
          children: [
            /*#__PURE__*/ (0, jsx_runtime_.jsxs)('header', {
              ...
              children: [
                ...
                patch.version !== latestPatch &&
                  currentVersion.currentRelease === latestRelease &&
                  /*#__PURE__*/ (0, jsx_runtime_.jsxs)('p', {
                    className: 'color-text-secondary mt-1',
                    children: [
                      /*#__PURE__*/ jsx_runtime_.jsx('span', {
      ...
      function GHESReleaseNotes({ context }) {
        const { currentLanguage, currentProduct } = (0, MainContext /* useMainContext */.Hv)()
        const { 0: focusedPatch, 1: setFocusedPatch } = (0, external_react_.useState)('')
        const {
          prevRelease,
          nextRelease,
                  ...
                  children: [
                    prevRelease
                      ? /*#__PURE__*/ (0, jsx_runtime_.jsxs)(Link /* Link */.r, {
                          ...
                          href: `/${currentLanguage}/${currentVersion.plan}@${prevRelease}/${
                            currentProduct === null || currentProduct === void 0
                              ? void 0
                              : currentProduct.id
                          }/release-notes`,
                          children: [
                            /*#__PURE__*/ jsx_runtime_.jsx(octicons_react_.ChevronLeftIcon, {}),
                            ' ',
                            prevRelease,
                          ],
                        })
                    ...
                    nextRelease
                      ? /*#__PURE__*/ (0, jsx_runtime_.jsxs)(Link /* Link */.r, {
                          className: 'btn btn-outline',
                          href: `/${currentLanguage}/${currentVersion.plan}@${nextRelease}/${
                            currentProduct === null || currentProduct === void 0
                              ? void 0
                              : currentProduct.id
                          }/release-notes`,
                          children: [
                            nextRelease,
                            ' ',
                            /*#__PURE__*/ jsx_runtime_.jsx(octicons_react_.ChevronRightIcon, {}),
                          ],
                        })
                      : /*#__PURE__*/ jsx_runtime_.jsx('div', {}),
                  ],
            ...
            /*#__PURE__*/ jsx_runtime_.jsx('aside', {
              ...
              children: /*#__PURE__*/ jsx_runtime_.jsx('nav', {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx('ul', {
                  className: 'list-style-none pl-0 text-bold',
                  children: releases.map((release) => {
                    const releaseLink = `/${currentLanguage}/${currentVersion.plan}@${
                      release.version
                    }/${
                      currentProduct === null || currentProduct === void 0
                        ? void 0
                      ...
                      return /*#__PURE__*/ jsx_runtime_.jsx(
                        'li',
                        {
                          ...
                          children: /*#__PURE__*/ (0, jsx_runtime_.jsxs)(Link /* Link */.r, {
                            ...
                            children: [
                              release.version,
                              /*#__PURE__*/ jsx_runtime_.jsx(octicons_react_.LinkExternalIcon, {}),
                            ],
                          }),
                        },
                        release.version
                                      ...
                                      children: /*#__PURE__*/ (0, jsx_runtime_.jsxs)(
                                        Link /* Link */.r,
                                        {
                                          ...
                                          children: [
                                            ...
                                            /*#__PURE__*/ jsx_runtime_.jsx('span', {
                                              className:
                                                'color-text-tertiary text-mono text-small text-normal',
                                              children: external_dayjs_default()(patch.date).format(
                                                'MMMM DD, YYYY'
                                              ),
                                            }),
                                          ],
      ...
      function ReleaseNotes({ mainContext, ghesContext, ghaeContext, currentVersion }) {
        return /*#__PURE__*/ jsx_runtime_.jsx(MainContext /* MainContext.Provider */.Tr.Provider, {
          ...
          children: /*#__PURE__*/ (0, jsx_runtime_.jsxs)(DefaultLayout /* DefaultLayout */.H, {
            children: [
              currentVersion.plan === 'enterprise-server' &&
                /*#__PURE__*/ jsx_runtime_.jsx(GHESReleaseNotes, {
                  context: ghesContext,
                }),
              currentVersion.plan === 'github-ae' &&
                /*#__PURE__*/ jsx_runtime_.jsx(GHAEReleaseNotes, {
                  context: ghaeContext,
                }),
            ],
          }),
  ...
  var __webpack_exports__ = __webpack_require__.X(0, [664, 317, 55], function () {
    return __webpack_exec__(2897)
  })
