...
exports.ids = [317]
exports.modules = {
  /***/ 2467: /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    'use strict'
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ m: function () {
        return /* binding */ LanguagesContext
      },
      /* harmony export */ u: function () {
        return /* binding */ useLanguages
      },
      /* harmony export */
    })
    ...
    const LanguagesContext = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0__.createContext)(
      null
    )
    const useLanguages = () => {
      const context = (0, react__WEBPACK_IMPORTED_MODULE_0__.useContext)(LanguagesContext)
  ...
  /***/ 7875: /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    'use strict'
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      ZP: function () {
        return /* binding */ initializeEvents
      },
      qP: function () {
    ...
    var external_js_cookie_default = /*#__PURE__*/ __webpack_require__.n(external_js_cookie_) // CONCATENATED MODULE: ./components/lib/get-csrf.ts
    function getCsrf() {
    ...
    var user_agent = __webpack_require__(7547) // CONCATENATED MODULE: ./components/lib/events.ts
    ...
    function getPerformance() {
      ...
      const paint =
        (_performance = performance) === null || _performance === void 0
          ? void 0
          : (_performance$getEntri = _performance.getEntriesByType('paint')) === null ||
            _performance$getEntri === void 0
          ? void 0
          : _performance$getEntri.find(({ name }) => name === 'first-contentful-paint')
      const nav =
        (_performance2 = performance) === null || _performance2 === void 0
          ? void 0
          : (_performance2$getEntr = _performance2.getEntriesByType('navigation')) === null ||
            _performance2$getEntr === void 0
          ? void 0
          : _performance2$getEntr[0]
      return {
    ...
    function initPageEvent() {
      ...
      pageEventId =
        pageEvent === null || pageEvent === void 0
          ? void 0
          : (_pageEvent$context = pageEvent.context) === null || _pageEvent$context === void 0
          ? void 0
          : _pageEvent$context.event_id
    }
          ...
          sendEvent({
            ...
            navigate_label: `details ${target.open ? 'open' : 'close'}: ${
              target === null || target === void 0
                ? void 0
                : (_target$querySelector = target.querySelector('summary')) === null ||
                  _target$querySelector === void 0
                ? void 0
                : _target$querySelector.innerText
            }`,
          })
        })
      )
      ;(_document$querySelect2 = document.querySelector('.sidebar-products')) === null ||
      _document$querySelect2 === void 0
        ? void 0
        : _document$querySelect2.addEventListener('click', (evt) => {
            const target = evt.target
  ...
  /***/ 7547: /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
    'use strict'
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ Z: function () {
        return /* binding */ parseUserAgent
      },
      /* harmony export */
    })
